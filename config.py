...
#--------------------------------------------
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "8198025806:")
APP_ID = int(os.environ.get("APP_ID", "27342258")) #Your API ID from my.telegram.org
API_HASH = os.environ.get("API_HASH", "df1d220364ecb7ac56d29152d194e14f") #Your API Hash from my.telegram.org
#--------------------------------------------

CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002779351012")) #Your db channel Id
OWNER = os.environ.get("OWNER", "upinputra") # Owner username without @
OWNER_ID = int(os.environ.get("OWNER_ID", "1580687565")) # Owner id
#--------------------------------------------
...
#1 Month
PRICE2 = os.environ.get("PRICE2", "12000")
#3 Month
